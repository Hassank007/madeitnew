...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Icons Overlay */}
      <div
        className="absolute inset-0 sm:top-20 2xl:top-48 top-28 sm:w-full w-full z-30 pointer-events-none bg-no-repeat sm:bg-top 
      ...
      {/* Content */}
      <div className="flex flex-col items-center justify-center pt-72 z-40 space-y-4 md:pt-64 sm:pt-72 s:pt-72 lg:pt-[27rem] xl:pt-96 2xl:pt-[42rem]">
